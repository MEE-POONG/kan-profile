      ...
      <div className="flex flex-col md:flex-row">
        <div >
          <div className='p-5 md:p-10'>
            ...
            <p className='kan text-5xl text-blue-800 mt-6'>PORTFOLIO</p>
            <div className='flex items-center mt-10 text-4xl md:text-blue-400 text-white' >
